...
.controller.xbox {
    background: url(https://imgur.com/hNi3y37);
    height: 630px;
    width: 750px;
    /*    margin-left: -375px;
        margin-top: -285px;*/
...
.xbox .trigger {
    width: 88px;
    height: 121px;
    background: url(https://imgur.com/udfkYG9);
    opacity: 0;
}
...
.xbox .bumper {
    width: 170px;
    height: 61px;
    background: url(https://imgur.com/YNTBa9x);
    opacity: 0;
}
...
.xbox .button {
    position: absolute;
    background: url(https://imgur.com/BjF2xXM);
    width: 48px;
    height: 48px;
}
...
.xbox .stick {
    position: absolute;
    background: url(https://imgur.com/4nhbXSe);
...
.xbox .face {
    background: url(https://imgur.com/DoFOI9P);
    position: absolute;
    opacity: 0;
}
